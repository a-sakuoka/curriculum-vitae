...
| Fortinet（FortiGate） | 2年 | ある程度教えられる |
| YAMAHA | 2年 | ある程度教えられる |
...
#### 【Sler】システム提案・設計・構築・運用保守【VMware/Hyper-V/Fortigate/WindowsServer/Linux】(2020年-2022年)
【プロジェクト概要】多数のエンドユーザと直接契約を結んでいるSler様のシステム設計・構築、保守対応を中心とした支援対応
［担当業務1］基本設計、詳細設計、環境構築、テスト、運用支援、保守対応、営業支援（見積り、営業同行）、売上UPや新サービス策定に於ける取組　など様々。具体的には下記。
- 参画しているSler様間とで契約を締結しているエンドユーザ様のシステム保守支援や障害対応を中心とて対応しておりますが、保守のみに限らず新規システムやリプレイスなどにおける設
構築も適時取り組んでおります。また営業支援による見積り対応や営業同行に実施。保守は主にリモートでの対応となりますが、オンサイト保守も実施。・参画しているSler様の企業としての売上UP施策や新規サービス策定に向けた取り組みの主担当として様々な提案を実施して参りました。
...
## 自己PR
IT業務経験は転職含めると15年目となりますが、これまでは富士通製品を主として取り扱い、設計・構築・単体/基盤テスト・運用保守などの中上流工程を多く経験して参りました。<br>
小規模案件ではリーダーとして1人で要件定義からの上流工程も経験があります。また社内・社外でのコミュニケーションも円滑に測りながら納品物への品質向上にも貢献しながら、期日は守り継続的に複数の案件請負をして欲しいとお客様から評価頂いたことも御座います。<br>
